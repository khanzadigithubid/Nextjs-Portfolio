        ...
        <div className="container mx-auto flex px-4 sm:px-5 py-12 sm:py-16 md:py-20 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-12 sm:mb-16 md:mb-0 items-center text-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <p className="text-base sm:text-lg leading-relaxed text-gray-300 max-w-2xl px-4 sm:px-0"
                   data-aos="fade-up"
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex justify-center md:justify-start space-x-4 sm:space-x-6 pt-3 sm:pt-4">
                  ...
                  >
                    <button className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 text-black bg-white rounded-full hover:bg-gray-200 transition-all duration-300 shadow-md hover:shadow-lg">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-4/5 sm:w-5/6" data-aos="fade-left" data-aos-duration="500">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-500 to-gray-700 rounded-2xl blur opacity-30 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
